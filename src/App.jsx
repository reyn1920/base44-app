        ...
        {links.map((l) => (
          <li key={l.to}>
            <a
              ...
              className={`block rounded-md px-3 py-2 hover:bg-[hsl(var(--accent))] ${current === l.to ? "bg-[hsl(var(--accent))]" : ""}`}
            >
              {l.label}
            </a>
          </li>
    ...
    <div className="grid gap-4">
      ...
      <div className="rounded-xl border bg-[hsl(var(--card))] p-4">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          <button className="rounded-md bg-[hsl(var(--primary))] px-3 py-1.5 text-[hsl(var(--primary-foreground))]">Primary</button>
          <button className="rounded-md border px-3 py-1.5">Secondary</button>
          <button className="rounded-md border px-3 py-1.5 hover:bg-[hsl(var(--accent))]">Outline</button>
          <button className="rounded-md px-3 py-1.5 hover:bg-[hsl(var(--accent))]">Ghost</button>
          <button className="rounded-md bg-[hsl(var(--destructive))] px-3 py-1.5 text-[hsl(var(--destructive-foreground))]">Delete</button>
        </div>
      </div>
      <div className="rounded-xl border bg-[hsl(var(--card))] p-4 text-sm text-[hsl(var(--muted-foreground))]">Tokens applied.</div>
    </div>
  );
}
    ...
    <div className="grid gap-4">
      ...
      <div className="rounded-xl border bg-[hsl(var(--card))] p-4">
        <div className="grid grid-cols-2 gap-3 max-w-lg">
          <label className="text-sm text-[hsl(var(--muted-foreground))]">Input</label>
          <input className="w-full rounded-md border bg-[hsl(var(--background))] px-3 py-2 text-sm" placeholder="Type here…" />
          <label className="text-sm text-[hsl(var(--muted-foreground))]">Select</label>
          <select className="w-full rounded-md border bg-[hsl(var(--background))] px-3 py-2 text-sm">
            <option>First</option><option>Second</option>
          </select>
          <label className="text-sm text-[hsl(var(--muted-foreground))]">Button</label>
...
function YouTubeFallback() {
  return (
    <div className="rounded-xl border bg-[hsl(var(--card))] p-6 text-sm">
  ...
  return (
    <div className="min-h-dvh bg-[hsl(var(--background))] text-[hsl(var(--foreground))]">
      <header className="border-b bg-[hsl(var(--card))]">
        <div className="mx-auto flex max-w-screen-2xl items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <span className="hidden text-sm text-[hsl(var(--muted-foreground))] sm:inline">UI Kit Demo</span>
          </div>
      ...
      <footer className="border-t bg-[hsl(var(--card))]">
        <div className="mx-auto max-w-screen-2xl px-4 py-4 text-sm text-[hsl(var(--muted-foreground))]">
