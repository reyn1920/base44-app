    ...
    <div className="mx-auto max-w-5xl p-6">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border bg-[hsl(var(--card))] p-6">
          ...
          <ul className="mt-2 list-disc pl-6 text-sm text-[hsl(var(--muted-foreground))]">
      ...
      <a href="#/pricing" className="mt-8 inline-block rounded-md border px-4 py-2 hover:bg-[hsl(var(--accent))]">Talk to sales</a>
    </div>
  );
}
