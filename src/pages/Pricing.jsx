...
function Plan({name, price, cta, features=[]}) {
  return (
    <div className="rounded-2xl border bg-[hsl(var(--card))] p-6">
      ...
      <a href="#/uikit" className="mt-6 inline-block rounded-md bg-[hsl(var(--primary))] px-4 py-2 text-[hsl(var(--primary-foreground))]">{cta}</a>
    </div>
  );
}
...
export default function Pricing() {
  return (
    <div className="mx-auto max-w-5xl p-6">
      ...
      <p className="mt-2 text-sm text-[hsl(var(--muted-foreground))]">Start free. Upgrade when your team grows.</p>
